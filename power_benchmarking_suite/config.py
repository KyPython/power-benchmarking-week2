...
class AppConfig:
    ...
    powermetrics: Optional[PowerMetricsConfig] = None
    arduino: Optional[ArduinoConfig] = None
...
class ConfigManager:
    ...
    def _load_config(self) -> Dict:
        ...
        if self.config_file.exists():
            try:
                if (
                    self.config_file.suffix == ".yaml" or self.config_file.suffix == ".yml"
                ) and YAML_AVAILABLE:
    ...
    def _default_config(self) -> Dict:
        ...
        return {
            ...
            "arduino": {"enabled": False, "port": "/dev/cu.usbmodem*", "baud_rate": 115200},
        ...
        try:
            if (
                ...
                with open(self.config_file, "w") as f:
                    yaml.dump(config, f, default_flow_style=False, sort_keys=False)  # type: ignore
            else:
                with open(self.config_file, "w") as f:
        ...
        if YAML_AVAILABLE:
            ...
            try:
                with open(profile_file, "w") as f:
                    yaml.dump(profile_data, f, default_flow_style=False, sort_keys=False)  # type: ignore
            except Exception as e:
